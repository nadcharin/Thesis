...
%   x_recon n x d matrix representing the model obtained by reconstruction from the projection of all x in X. Note, x_recon is the
%           unscaled reconstruction.
%   x_proj  n x k matrix representing the lower-dimensional representation of X.
%
% DESCRIPTION
% This code implements the random projection method to find outliers in multivariate time series from reconstruction errors as 
% retrieved by projecting the data onto k approximately orthonormal projection vectors.
%
